...
class MyCobotGripperBase(GripperModel):
    """
    Gripper for Franka's Panda (has two fingers).
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/mycobot_gripper.xml"), idn=idn)
    ...
    @property
    def init_qpos(self):
        return np.array([0.020833, -0.020833, 0, 0, 0, 0,])
...
class MyCobotGripper(MyCobotGripperBase):
    """
